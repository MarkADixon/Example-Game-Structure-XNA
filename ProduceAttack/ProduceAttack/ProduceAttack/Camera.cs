...
namespace ProduceAttack
{
    public static class Camera
    {
        ...
        private const int WorldEdgeBuffer = 20;
        ...
        private static int scoreComboResetTimer = 0; //in ms
        private const int scoreComboResetThreshold = 3000; //in ms
        ...
        {
            score = score + (value * scoreCombo * 100);
            scoreComboResetTimer = 0;
            return;
        }

        public static void AddScoreCombo(int value)
        {
            scoreCombo += value;
            scoreComboResetTimer = 0;
            return;
        ...
        public static void Update(GameTime gameTime)
        {
            ...
            if (scoreCombo != 1)
            {
                scoreComboResetTimer += gameTimeMS;
                if (scoreComboResetTimer > scoreComboResetThreshold)
                {
                    scoreCombo = 1;
                    scoreComboResetTimer = 0;
                }
        ...
        public static void SetScreenRectangle()
        {
            ...
            WorldRectangle = screenRectangle;
        }
        ...
        public static void SmoothScroll()
        {
            ...
            Position = new Vector2(position.X + dpos.X / 20f,
                                    position.Y + dpos.Y / 20f);
            if (dpos.Length() < 3)
            {
